...
class OnBoardFragment : Fragment(), ClickListener {
    lateinit var binding: FragmentOnBoardBinding
    private val viewModel : OnBoardNewsViewModel by viewModels()
    ...
    override fun onClick(extras: FragmentNavigator.Extras, new: New) {
        try{
            findNavController().navigate(R.id.action_onBoardFragment_to_postDetailsFragment
