...
import com.example.norwayapplicationxml.databinding.FragmentPoliticalNewsBinding
...
class PoliticalNewsFragment : Fragment() , ClickListener{
    lateinit var binding:FragmentPoliticalNewsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPoliticalNewsBinding.inflate(layoutInflater)
        return binding.root
    }

    override fun onClick(extras: FragmentNavigator.Extras, new: New) {
        try{
            findNavController().navigate(R.id.action_politicalNewsFragment_to_postDetailsFragment
